                        ...
                        <th>  
                            <div class="form-check">
                              <label class="form-check-label">
                                <input class="form-check-input" id="perentCheckbox" type="checkbox" value="">
                    ...
                    <tbody>
                      ...
                      <tr>
                          <td> 
                              <div class="form-check">
                                <label class="form-check-label">
                                <input name="checkbox" id ="{{$category->id}}" class="form-check-input childCheckbox" type="checkbox">
                                  <span class="form-check-sign">
                                    <span class="check"></span>
                                  </span>
                                </label>
